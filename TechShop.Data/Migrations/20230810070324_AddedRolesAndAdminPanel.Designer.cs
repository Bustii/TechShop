...
namespace TechShop.Data.Migrations
{
    ...
    [Migration("20230810070324_AddedRolesAndAdminPanel")]
    partial class AddedRolesAndAdminPanel
    {
            ...
            modelBuilder.Entity("TechShop.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 10, 7, 3, 23, 575, DateTimeKind.Utc).AddTicks(7752));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9068),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9132),
                            Model = "Acer",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9148),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9150),
                            Model = "MSI",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9155),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9157),
                            Model = "Asus",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9161),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 10, 10, 3, 23, 575, DateTimeKind.Local).AddTicks(9163),
                            Model = "Asus",
                            Name = "ROG Hyperion",
                            Price = 5000.00m
                        });
