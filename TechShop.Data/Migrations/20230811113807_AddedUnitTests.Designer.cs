...
namespace TechShop.Data.Migrations
{
    ...
    [Migration("20230811113807_AddedUnitTests")]
    partial class AddedUnitTests
    {
            ...
            modelBuilder.Entity("TechShop.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 11, 11, 38, 7, 471, DateTimeKind.Utc).AddTicks(243));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1826),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1873),
                            Model = "Acer",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1891),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1893),
                            Model = "MSI",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1898),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1901),
                            Model = "Asus",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1905),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 14, 38, 7, 471, DateTimeKind.Local).AddTicks(1908),
                            Model = "Asus",
                            Name = "ROG Hyperion",
                            Price = 5000.00m
                        });
