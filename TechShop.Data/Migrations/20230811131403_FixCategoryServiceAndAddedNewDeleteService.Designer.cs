...
namespace TechShop.Data.Migrations
{
    ...
    [Migration("20230811131403_FixCategoryServiceAndAddedNewDeleteService")]
    partial class FixCategoryServiceAndAddedNewDeleteService
    {
            ...
            modelBuilder.Entity("TechShop.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 11, 13, 14, 2, 640, DateTimeKind.Utc).AddTicks(5372));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6748),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6836),
                            Model = "Acer",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6858),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6861),
                            Model = "MSI",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6868),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6870),
                            Model = "Asus",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6880),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            LastEdit = new DateTime(2023, 8, 11, 16, 14, 2, 640, DateTimeKind.Local).AddTicks(6882),
                            Model = "Asus",
                            Name = "ROG Hyperion",
                            Price = 5000.00m
                        });
