...
namespace TechShop.Data.Migrations
{
    ...
    [Migration("20230809080304_InitialDb")]
            ...
            modelBuilder.Entity("TechShop.Data.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 9, 8, 3, 3, 890, DateTimeKind.Utc).AddTicks(2384));
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 3,
                            CreatedOn = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3602),
                            ...
                            IsActive = true,
                            LastEdit = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3650),
                            Model = "Acer",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3667),
                            ...
                            IsActive = true,
                            LastEdit = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3669),
                            Model = "MSI",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3675),
                            ...
                            IsActive = true,
                            LastEdit = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3677),
                            Model = "Asus",
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3682),
                            ...
                            IsActive = true,
                            LastEdit = new DateTime(2023, 8, 9, 11, 3, 3, 890, DateTimeKind.Local).AddTicks(3685),
                            Model = "Asus",
                            Name = "ROG Hyperion",
                            Price = 5000.00m
                        });
